...
import {
  ...
  setAuthPersistence,
  supabaseNoPersist,
} from '@shared/services/supabaseClient'
import { useERPData } from '@shared/store/appStore'
import type { Employee } from '@shared/types/erp'
import { resolveAppKind } from '@shared/utils/appContext'
import { resolveDeviceId, resolveDeviceInfo } from '@shared/utils/device'
import { createId } from '@shared/utils/ids'
import { verifyPin } from '@shared/utils/pin'
import { playBeep, startTone, stopTone } from '@shared/utils/sound'
